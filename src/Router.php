...
class Router {
     ...
     */
    private function scanDirectory($directory, $baseRoute = '') {
        ...
        foreach ($files as $file) {
            ...
            if (is_dir($path)) {
                ...
                $dirRoute = $file;
                $this->scanDirectory($path, $route . '/' . $dirRoute);
            } else {
                // Handle file (route endpoint)
                ...
                if ($fileName === 'index') {
                    ...
                    $this->addRoute($paramRoute, $path, [$paramName]);
                } else {
                    // Regular file
                    $this->addRoute($route . '/' . $fileName, $path);
                }
            }
        }
    }
